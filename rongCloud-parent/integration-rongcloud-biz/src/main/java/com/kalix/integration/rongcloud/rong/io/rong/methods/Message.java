package com.kalix.integration.rongcloud.rong.io.rong.methods;

import com.kalix.integration.rongcloud.rong.io.rong.messages.TxtMessage;
import com.kalix.integration.rongcloud.rong.io.rong.messages.VoiceMessage;
import com.kalix.integration.rongcloud.rong.io.rong.messages.BaseMessage;
import com.kalix.integration.rongcloud.rong.io.rong.models.CodeSuccessResult;
import com.kalix.integration.rongcloud.rong.io.rong.models.HistoryMessageResult;
import com.kalix.integration.rongcloud.rong.io.rong.models.TemplateMessage;
import com.kalix.integration.rongcloud.rong.io.rong.util.GsonUtil;
import com.kalix.integration.rongcloud.rong.io.rong.util.HostType;
import com.kalix.integration.rongcloud.rong.io.rong.util.HttpUtil;
...
*        @return CodeSuccessResult
	 **/
	public CodeSuccessResult publishPrivate(String fromUserId, String[] toUserId, VoiceMessage message, String pushContent, String pushData, String count, Integer verifyBlacklist, Integer isPersisted, Integer isCounted, Integer isIncludeSender) throws Exception {
		if (fromUserId == null) {
...
*     @return CodeSuccessResult
	 **/
	public CodeSuccessResult PublishSystem(String fromUserId, String[] toUserId, TxtMessage message, String pushContent, String pushData, Integer isPersisted, Integer isCounted) throws Exception {
		if (fromUserId == null) {
			throw new IllegalArgumentException("Paramer 'fromUserId' is required");
		}
